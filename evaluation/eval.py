...
def get_metrics(dataset_ref, dataset_hyp, service_schemas, in_domain_services, joint_acc_across_turn, use_fuzzy_match):
...
def main(prediction_dir, dstc8_data_dir, eval_set, output_metric_file, joint_acc_across_turn=False, use_fuzzy_match=True):
  ...
  all_metric_aggregate, _ = get_metrics(dataset_ref, dataset_hyp, eval_services,
                                        in_domain_services, joint_acc_across_turn, use_fuzzy_match)
